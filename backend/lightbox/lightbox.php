...
function register_assets() {
	wp_register_style( 'baguettebox-css', THEME . '/backend/lightbox/dist/baguetteBox.min.css' , [], '1.11.1' );
	wp_register_script( 'baguettebox', THEME . '/backend/lightbox/dist/baguetteBox.min.js', [], '1.11.1', true );
