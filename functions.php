...
function add_custom_scripts() {
    ...
    // Google Font
    wp_enqueue_style( 'google-font-barlow', '//fonts.googleapis.com/css2?family=Barlow:wght@300;400;500;600;700;800&display=swap', array(), 1.0);
}
...
// Add Image Size
// =============================================================
add_image_size( 'gallery', 600, 450, array( 'center', 'center' ) ); // Hard crop left top
